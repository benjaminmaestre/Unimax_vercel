...
// Definición de las traducciones compartidas del sistemaconst translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'hero.desc': 'Servicio y venta de concreto premezclado (mixer) en Lima y todo el Perú. Mezclas dosificadas electrónicamente (compatible con requerimientos de marcas líderes como Unicon), bombeo de precisión y despacho rápido.',
    ...
    'concrete.hero.desc': 'Venta y suministro de concreto premezclado (mixer) de alta resistencia en Lima y todo el Perú. Mezclas certificadas dosificadas electrónicamente (ideal para vaciados de concreto Unicon o similares) con despacho continuo.',
    'concrete.intro.title': 'GESTIÓN IMPECABLE Y SOPORTE TÉCNICO DE ALTO NIVEL',
    'concrete.intro.desc': 'En Unimaxcorp, garantizamos que cada metro cúbico de concreto premezclado (comúnmente llamado concreto Unicon por su estándar industrial) llegue a su obra con la precisión y calidad exigidas por las normas internacionales.',
    ...
    'concrete.versatility.desc': 'Contamos con una amplia gama de diseños de mezcla formulados bajo altos estándares (comparables a la calidad tradicional de concreto Unicon o Mixercon). Nuestra variedad permite cubrir desde elementos no estructurales hasta alta exigencia estructural.',
    ...
    'pump.ventajas.compatibilidad.title': 'Compatibilidad Logística (Unicon, Mixercon)',
    'pump.ventajas.compatibilidad.desc': 'Nuestro servicio de alquiler de bomba de concreto está preparado para bombear concreto premezclado de Unicon, Mixercon y otros proveedores en Lima hoy, coordinando el despacho directamente para un vaciado continuo.',
    'concrete.refrigerado.title': 'Concreto Refrigerado (Hielo)',
    'concrete.refrigerado.desc': 'Control térmico de la mezcla mediante hielo o aditivos para evitar fisuras en vaciados masivos o de alto espesor.',
    ...
    'machinery.pump.btn': 'VER DETALLES DE BOMBEO',
    'machinery.equipos.title': 'Otras Maquinarias Disponibles',
    'machinery.equipos.retro.title': 'Retroexcavadoras',
    'machinery.equipos.retro.desc': 'Máxima versatilidad para excavación, zanjas y movimiento de tierras en espacios reducidos.',
    'machinery.equipos.cargador.title': 'Cargadores Frontales',
    'machinery.equipos.cargador.desc': 'Potencia y gran capacidad de carga para movimiento masivo de agregados y desmonte.',
  ...
  en: {
    ...
    'pump.ventajas.compatibilidad.title': 'Logistics Compatibility (Unicon, Mixercon)',
    'pump.ventajas.compatibilidad.desc': 'Our concrete pump rental service is ready to pump ready-mix concrete from Unicon, Mixercon, and other suppliers in Lima today, coordinating dispatch directly for a continuous pour.',
    'concrete.refrigerado.title': 'Refrigerated Concrete (Ice)',
    'concrete.refrigerado.desc': 'Thermal control of the mix using ice or admixtures to prevent cracking in mass pours or high-thickness elements.',
    ...
    'machinery.pump.btn': 'VIEW PUMPING DETAILS',
    'machinery.equipos.title': 'Other Available Machinery',
    'machinery.equipos.retro.title': 'Backhoe Loaders',
    'machinery.equipos.retro.desc': 'Maximum versatility for excavation, trenching, and earthmoving in confined spaces.',
    'machinery.equipos.cargador.title': 'Wheel Loaders',
    'machinery.equipos.cargador.desc': 'Power and large load capacity for massive movement of aggregates and debris.',
