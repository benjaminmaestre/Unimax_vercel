...
// Definición de las traducciones compartidas del sistemaconst translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'hero.desc': 'Servicio y venta de concreto premezclado (mixer) en Lima y todo el Perú. Mezclas dosificadas electrónicamente, bombeo de precisión y despacho rápido.',
    ...
    'concrete.hero.desc': 'Venta y suministro de concreto premezclado (mixer) de alta resistencia en Lima y todo el Perú. Mezclas dosificadas electrónicamente y despacho continuo para vaciados programados.',
    'concrete.intro.title': 'GESTIÓN IMPECABLE Y SOPORTE TÉCNICO DE ALTO NIVEL',
    'concrete.intro.desc': 'En Unimaxcorp, coordinamos cada metro cúbico de concreto premezclado para que llegue a la obra con la precisión, trazabilidad y calidad exigidas por las especificaciones del proyecto.',
    ...
    'concrete.versatility.desc': 'Contamos con una amplia gama de diseños de mezcla formulados bajo criterios técnicos y control de dosificación. Nuestra variedad permite cubrir desde elementos no estructurales hasta aplicaciones de alta exigencia.',
    ...
    'pump.ventajas.compatibilidad.title': 'Coordinación con el proveedor de concreto',
    'pump.ventajas.compatibilidad.desc': 'Nuestro servicio de bomba puede coordinarse con el suministro de concreto premezclado de distintos proveedores para mantener un vaciado continuo y una programación clara en obra.',
  ...
  en: {
    ...
    'pump.ventajas.compatibilidad.title': 'Concrete supplier coordination',
    'pump.ventajas.compatibilidad.desc': 'Our pumping service can coordinate with ready-mix concrete supplied by different providers to support a continuous pour and clear site scheduling.',
