...
export function ConcreteDetails() {
  ...
  const tableRows = [
    ...
    { fc: '175–210', unit: 'kg/cm²', app: language === 'es' ? 'Rango habitual en proyectos residenciales. Utilizado en cimientos, columnas, vigas y losas aligeradas según especificación.' : 'A common range for residential projects. Used in foundations, columns, beams, and lightweight slabs as specified.' },
